...
module name_of_sram_module(
  ...
  assign RW0O_0 = {RW0O_0_3[32'd1:32'd0] ,RW0O_0_2[32'd7:32'd0] ,RW0O_0_1[32'd1:32'd0] ,RW0O_0_0[32'd7:32'd0]};
  assign RW0O = ((32'd0 == 32'd0)) ? (RW0O_0) : (20'd0);
endmodule
EOF
